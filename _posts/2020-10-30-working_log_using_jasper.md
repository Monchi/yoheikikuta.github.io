...
- 分析系のタスクは SQL クエリだけだと情報が不十分なことが多く、ログに過程を残しておくと便利
- チームで同じようにログを残しておくと作業追いやすいしコメントとかも随時入れられるのでよい
<br>
...
作業者の考察、アプリケーションを管理しているチームの人に聞いたときの Slack のリンク、原因と思しきプロダクションコードへの PR のリンク、問題を誰とコミュニケーションしてどうやって修正したか、などなどが本質的に重要な情報となる。
